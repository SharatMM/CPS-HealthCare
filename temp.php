...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" style="text-align: center;" href="#"><strong>Your Details</strong></a>
    </div>
    <ul class="nav navbar-nav navbar-right">	
      <li><a href="sharan2.php">Home</a></li>
      <li><a href="index1.html">Sign Out</a></li>
    </ul>
  </div>
</nav>
...
$query = $_SESSION['login_user']; 
        ...
        $sql = "SELECT * FROM patient,doctor where p_id='$query' and d_id=doc_id; " or die(mysqli_error($sql));
        ...
        { 
            while($results = mysqli_fetch_array($raw_results,MYSQLI_ASSOC))
            {
               ...
               echo "<h4 style='text-align:center;'>Managing Doctor : <span style='color:red;'> " .$results['d_name']."</span></h4>";  
            }
